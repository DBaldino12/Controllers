...
--
-- Table structure for table `Abandoned_email_subscription`
--

CREATE TABLE IF NOT EXISTS `Abandoned_email_subscription` (
...
--
-- Dumping data for table `Abandoned_email_subscription`
--
...
--
-- Table structure for table `abandoned_extensionsetting`
--

CREATE TABLE IF NOT EXISTS `abandoned_extensionsetting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `abandoned_extensionsetting`
--
...
--
-- Table structure for table `abandoned_user_ip`
--
...
--
-- Dumping data for table `abandoned_user_ip`
--
...
--
-- Table structure for table `Abandon_cart_licensekey`
--
...
--
-- Dumping data for table `Abandon_cart_licensekey`
--

-- --------------------------------------------------------

--
-- Table structure for table `Abandon_cart_users`
--
...
--
-- Dumping data for table `Abandon_cart_users`
--
...
--
-- Table structure for table `abandon_email_template`
--
...
--
-- Dumping data for table `abandon_email_template`
--
