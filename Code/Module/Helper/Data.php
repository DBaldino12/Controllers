<?php
class Pricelizer_Module_Helper_Data extends Mage_Core_Helper_Abstract
{
...
if(!$sessionCustomer->isLoggedIn()) {
       ...
       $read4 = Mage::getSingleton('core/resource')->getConnection('core_read') ;
		...
		$resource = Mage::getSingleton('core/resource');
									...
									{
		 if(isset($modulesArray['Pricelizer_Module']))
					...
					jQuery( document ).ready(function() {
					    ...
					    if(isOk==true)
						{
							...
							var cart = <?php echo $cart_qty; ?>;
							 ...
							 jQuery.ajax({
								url:"<?php echo $base_url; ?>/app/code/community/Pricelizer/Module/Helper/checkcart.php",
								type:'POST',
								data:'cart='+cart,
								success:function(results)
								{
									if(results != 'no')
									{	
										window.location='<?php  echo $base1_url; ?>module/frontmodule/autoLogin';
									}
								}
							});
						}
